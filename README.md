...
[![CI/CD](https://github.com/YOUR_USERNAME/jwt-secrets-manager/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/jwt-secrets-manager/actions)
[![Coverage](https://codecov.io/gh/YOUR_USERNAME/jwt-secrets-manager/branch/main/graph/badge.svg)](https://codecov.io/gh/YOUR_USERNAME/jwt-secrets-manager)
...
```bash
git clone https://github.com/YOUR_USERNAME/jwt-secrets-manager
...
curl -X POST http://localhost:8000/secrets/ \
  ...
  -H "Content-Type: application/json" \
  -d '{"name": "stripe-api-key", "value": "sk_live_...", "rotate_after_days": 30}'
...
│   ├── auth/
│   │   ├── rsa_keys.py      # RSA 2048-bit key generation + rotation
│   │   ├── jwt_handler.py   # JWT sign/verify with RS256
│   │   ├── aes_encrypt.py   # AES-256-GCM encryption/decryption
│   │   ├── redis_client.py  # Token blacklisting + rate limiting
...
├── tests/
│   └── test_auth.py         # Security + integration tests (85%+ coverage)
├── Dockerfile
├── docker-compose.yml
